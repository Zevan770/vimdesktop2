...
Commands:
  ...
  cycle-stack-index
          Cycle the index of the focused window in the focused stack in the specified cycle
          direction
  focus-stack-window
  ...
  toggle-workspace-window-container-behaviour
          ...
          workspace. If there was no behaviour set for the workspace previously it takes the
  ...
  toggle-lock
          Toggle a lock for the focused container, ensuring it will not be displaced by any new
          windows
  restore-windows
  ...
  watch-configuration
          Enable or disable watching of legacy komorebi.ahk or komorebi.ps1 configurations (if they
          exist)
  ...
  enforce-workspace-rules
          Enforce all workspace rules, including initial workspace rules that have already been
          applied
